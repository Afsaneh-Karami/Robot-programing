...
class image_converter():
    ...
    def __init__(self):
        ...
        self.image_sub_color = rospy.Subscriber("/thorvald_001/kinect2_right_camera/hd/image_color_rect", Image, self.image_color_callback)
        self.image_sub_depth=rospy.Subscriber("/thorvald_001/kinect2_right_sensor/sd/image_depth_rect",Image, self.image_depth_callback)
...
#startWindowThread()
rospy.init_node('image_converter1')
ic = image_converter()
rospy.spin()
